...
METUI_FUN['product_list_met_16_1_9'] = {
name:'product_list_met_16_1_9',
appear:function (){
...
navtab:function(){
var $met_indexpro_navtabs=METUI['product_list_met_16_1_9'].find(".nav-tabs");
var list=METUI['product_list_met_16_1_9'].find('.index-product-list');
...
var x = new metui(METUI_FUN['product_list_met_16_1_9']);
METUI_FUN['about_list_met_16_1_21'] = {
name:'about_list_met_16_1_21',
appear:function (){
var indexappear=$('.met-index-body:eq(0) [data-plugin=appear]');
if(indexappear.length){
indexappear.scrollFun(function(val){
...
var x = new metui(METUI_FUN['about_list_met_16_1_21']);